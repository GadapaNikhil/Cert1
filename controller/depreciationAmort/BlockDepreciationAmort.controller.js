sap.ui.define([
	...
	var TableController = Controller.extend("sap.uxap.sample.ObjectPageOnJSON.controller.depreciationAmort.BlockDepreciationAmort", {

		onInit: function () {
			// set explored app's demo model on this sample
			var oModel = new JSONModel(sap.ui.require.toUrl("sap/uxap/sample/ObjectPageOnJSON/products.json"));
